...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.cameraIrFovView.setGeometry(QRect(0, 0, 670, 515))
        ...
        self.cbPatientBtn.setChecked(True)
        ...
        self.angleViewerDockScrollAreaContents.setGeometry(QRect(0, 0, 383, 356))
