...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QRect(15, 67, 111, 16))
        ...
        self.hsMinDetectionConfidence.setValue(90)
        self.hsMinDetectionConfidence.setSliderPosition(90)
        ...
        self.hsAnglesViewerRange.setMinimum(1)
        self.hsAnglesViewerRange.setMaximum(50)
        self.hsAnglesViewerRange.setPageStep(1)
        self.hsAnglesViewerRange.setValue(6)
        self.hsAnglesViewerRange.setSliderPosition(6)
        ...
        self.label_6.setGeometry(QRect(15, 451, 201, 16))
        self.label_6.setFont(font1)
        self.cbPosturalAssessment = QComboBox(self.groupBox)
        self.cbPosturalAssessment.addItem("")
        self.cbPosturalAssessment.addItem("")
        self.cbPosturalAssessment.setObjectName(u"cbPosturalAssessment")
        self.cbPosturalAssessment.setEnabled(True)
        self.cbPosturalAssessment.setGeometry(QRect(15, 470, 231, 31))
        ...
        self.angleViewerDockScrollAreaContents.setGeometry(QRect(0, 0, 320, 378))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(QCoreApplication.translate("MainWindow", u"Kinect Framerate", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"DepthMode", None))
        self.cbDepthMode.setItemText(0, QCoreApplication.translate("MainWindow", u"NFOV_BD", None))
        self.cbDepthMode.setItemText(1, QCoreApplication.translate("MainWindow", u"NFOV_UNBD", None))
        self.cbDepthMode.setItemText(2, QCoreApplication.translate("MainWindow", u"WFOV_BD", None))
        ...
        self.tvMinDetectionConfidence.setText(QCoreApplication.translate("MainWindow", u"Min Detection Confidence (0.9)", None))
        ...
        self.tvAnglesRangeFrames.setText(QCoreApplication.translate("MainWindow", u"Angles-Viewer Range (6 sec)", None))
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Postural Assessment", None))
        self.cbPosturalAssessment.setItemText(0, QCoreApplication.translate("MainWindow", u"\u6b65\u6001\u5206\u6790 - \uff08\u819d\u5173\u8282/\u9acb\u5173\u8282\uff09", None))
        self.cbPosturalAssessment.setItemText(1, QCoreApplication.translate("MainWindow", u"\u4e0b\u8e72\u68c0\u6d4b - \uff08\u819d\u5173\u8282/\u8e1d\u5173\u8282\uff09", None))
